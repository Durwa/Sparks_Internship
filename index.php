...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>APNA SAPNA BANK</h2></a>
     ...
     <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="main_text">APNA SAPNA BANK</h1>
  ...
  <section class="contactus" id="contact" >
       ...
       <footer><center>&#169; 2021 THE SPARKS FOUNDATION | DESIGNED BY DURWA PATIL</center></footer>
</body>
</html>